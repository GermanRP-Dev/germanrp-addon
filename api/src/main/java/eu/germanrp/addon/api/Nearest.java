...
/**
 * Represents an entity or object that has a position in space and can be identified
 * as the nearest to a given reference point. This interface provides a method to
