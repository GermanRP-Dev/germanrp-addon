...
public enum Graffiti {
    ...
    GARAGE_HOLDEN_TOWER("Tiefgarage (Holden-Tower)", new IntVector3(508, 61, -849)),
    APOTHEKE_1("Apotheke-1 (Downtown)", new IntVector3(646, 68, -942)),
    ...
    POST("Postzentrale (Downtown)", new IntVector3(768, 68, -1061)),
